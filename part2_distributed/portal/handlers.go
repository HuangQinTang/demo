...
func (studentsHandler) renderStudents(w http.ResponseWriter, r *http.Request) {
	...
	res, err := http.Get(serviceURL[0] + "/students")
	if err != nil {
		return
	}
...
func (studentsHandler) renderStudent(w http.ResponseWriter, r *http.Request, id int) {
	...
	res, err := http.Get(fmt.Sprintf("%v/students/%v", serviceURL[0], id))
	if err != nil {
		return
	}
...
func (studentsHandler) renderGrades(w http.ResponseWriter, r *http.Request, id int) {
	...
	res, err := http.Post(fmt.Sprintf("%v/students/%v/grades", serviceURL[0], id), "application/json", bytes.NewBuffer(data))
	if err != nil {
